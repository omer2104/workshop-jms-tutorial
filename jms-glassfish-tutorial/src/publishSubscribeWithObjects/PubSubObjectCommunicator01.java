...
public class PubSubObjectCommunicator01 implements MessageListener {
	public static final String TOPIC01 = "jms/Topic01";
	public static final String TOPIC02 = "jms/Topic02";
	
	public static void main(String[] args) throws NamingException, JMSException, IOException {
		PubSubObjectCommunicator01 communicator1 = new PubSubObjectCommunicator01();
		Context initialContext = PubSubObjectCommunicator01.getInitialContext();
		Topic topic01 = (Topic) initialContext.lookup(PubSubObjectCommunicator01.TOPIC01);
		Topic topic02 = (Topic) initialContext.lookup(PubSubObjectCommunicator01.TOPIC02);
		...
		communicator1.subscribe(topicConnection, topic02);
		communicator1.publish(topicConnection, topic01);
	}
